...
<tr>
    <td>CASCADE</td>
    <td>Deletes all related rows in child table</td>
</tr>
<tr>
    <td>SET NULL</td>
    <td>Sets the foreign key to NULL in the child table</td>
</tr>
<tr>
    <td>RESTRICT</td>
    <td>Prevents deletion of parent if child exists (default)</td>
</tr>
</table>